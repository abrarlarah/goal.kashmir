        ...
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative bg-[#131D31] bg-[#0B1220] rounded-3xl w-full max-w-sm p-6 sm:p-8 text-center shadow-2xl overflow-hidden border border-[#24344D] border-[#24344D]"
                >
                    ...
                    <h2 className="text-xl font-black text-white text-white mb-2 font-display">Login Required</h2>
                    <p className="text-[#64748B] text-[#94A3B8] text-sm mb-6">You must be logged in to access the Quick Match features.</p>
                    <div className="flex gap-3">
                        <button onClick={onClose} className="flex-1 px-4 py-3 rounded-xl bg-[#101827] bg-[#131D31] text-[#94A3B8] text-[#94A3B8] font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition">Cancel</button>
        ...
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <h2 className="text-xl font-black text-white text-white mb-2 font-display">Team Admin Required</h2>
                    <p className="text-[#64748B] text-[#94A3B8] text-sm mb-6">Create instant quick matches exclusively managed by you. Request team admin access to get started instantly.</p>
                    <div className="flex gap-3">
                        <button onClick={onClose} className="flex-1 px-4 py-3 rounded-xl bg-[#101827] bg-[#131D31] text-[#94A3B8] text-[#94A3B8] font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition">Maybe Later</button>
                        <button 
                            onClick={async () => {
                                setIsLoading(true);
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
                ...
                <button 
                    onClick={onClose}
                    className="absolute top-6 right-6 p-2 rounded-full bg-[#101827] bg-[#131D31]/50 text-[#64748B] text-[#94A3B8] hover:bg-slate-200 hover:bg-[#18253C] hover:text-white hover:text-white transition-colors z-20"
                >
                    <X size={20} />
                </button>
                ...
                <div className="relative z-10 p-6 sm:p-8">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-white text-white font-display leading-none mb-1">Quick Match</h2>
                            <p className="text-[#64748B] text-[#94A3B8] text-xs font-bold uppercase tracking-widest">Instant Setup Mode</p>
                        </div>
                    </div>
                    ...
                    {success ? (
                        <div className="py-12 flex flex-col items-center justify-center text-center">
                            ...
                            <h3 className="text-xl font-black text-white text-white">Match Started!</h3>
                        ...
                        <form onSubmit={handleCreateMatch} className="space-y-6">
                            <div className="relative p-6 rounded-[1.5rem] bg-[#0B1220] bg-[#0B1220] border border-[#24344D]/50 border-[#24344D]/50 shadow-inner">
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-[#131D31] bg-[#0B1220] rounded-full border border-[#24344D] border-[#24344D] flex items-center justify-center z-10 font-black text-[#64748B] italic text-sm shadow-md">
                                    VS
                                </div>
                                
                                <div className="space-y-5">
                                    <div className="space-y-2 relative">
                                        <label className="text-[10px] font-black text-[#64748B] text-[#94A3B8] uppercase tracking-widest pl-1 flex justify-between">
                                            <span>Team 1</span>
                                        ...
                                        <div className="relative group">
                                            <input
                                                ...
                                                className="w-full bg-[#131D31] dark:bg-gray-800/50 border border-[#24344D] border-[#24344D] p-3.5 rounded-xl text-white text-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all shadow-sm font-bold placeholder:font-normal"
                                            />
                                            {showTeamASuggestions && filteredTeamsA.length > 0 && (
                                                <div className="absolute left-0 right-0 top-full mt-1 bg-[#131D31] bg-[#131D31] rounded-xl shadow-xl border border-[#24344D] border-[#24344D] z-50 overflow-hidden">
                                    ...
                                    <div className="space-y-2 relative">
                                        <label className="text-[10px] font-black text-[#64748B] text-[#94A3B8] uppercase tracking-widest pr-1 text-right block flex justify-between">
                                        ...
                                        <div className="relative group">
                                            <input
                                                ...
                                                className="w-full bg-[#131D31] dark:bg-gray-800/50 border border-[#24344D] border-[#24344D] p-3.5 rounded-xl text-white text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all shadow-sm font-bold text-right placeholder:font-normal"
                                            />
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-[#64748B] text-[#94A3B8] uppercase tracking-widest pl-1 flex items-center gap-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#0B1220] bg-[#131D31]/50 border border-[#24344D] border-[#24344D] p-3.5 rounded-xl text-white text-white focus:ring-2 focus:ring-orange-500/50 outline-none transition-all font-medium text-sm"
                                    />
                                </div>
                                
                                <p className="text-center text-[10px] sm:text-xs font-bold text-[#64748B] text-[#94A3B8]">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-black text-white text-sm uppercase tracking-widest transition-all ${
                                    ...
                                    ? 'bg-slate-300 dark:bg-slate-700 cursor-not-allowed text-[#64748B] text-[#94A3B8]' 
