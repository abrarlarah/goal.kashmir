...
export default function PrivateRoute({ children, requireSuperAdmin = false, requireTournamentAdmin = false, requireTeamAdmin = false, requireNewsAdmin = false, requireAdminPanelAccess = false }) {
  ...
  if (!hasAnyAdminAccess) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <h2 className="text-2xl font-bold text-white text-white mb-2">Access Denied</h2>
  ...
  if (requireSuperAdmin && !isSuperAdmin) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        <div className="text-6xl mb-4">👑</div>
        <h2 className="text-2xl font-bold text-white text-white mb-2">Super Admin Only</h2>
        <p className="text-[#64748B] dark:text-gray-400 max-w-md">
