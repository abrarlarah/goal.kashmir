...
const NewsDetail = () => {
    ...
    return (
        ...
        >
            <Link
                to="/news"
                className="inline-flex items-center gap-2 text-[#94A3B8] hover:text-white transition-colors mb-8 group"
            >
            ...
            <article className="space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <motion.div
                        ...
                        className="flex flex-wrap items-center gap-6 text-[#94A3B8] text-sm py-4 border-y border-[#24344D]/40"
                    >
                ...
                >
                    ...
                    <div className="text-[#94A3B8] leading-relaxed text-lg whitespace-pre-wrap">
                        {article.content}
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="pt-12 mt-12 border-t border-[#24344D]/40 flex items-center justify-between"
                >
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-[#131D31]/50 hover:bg-[#131D31]/10 text-white rounded-xl transition-colors"
                        >
                            <Share2 size={18} />
                            Share Article
                        </button>
