        ...
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
            {successMessage && (
                <div className="fixed top-24 right-4 z-50 animate-bounce">
                    <div className="bg-green-500 text-white px-6 py-3 rounded-2xl shadow-2xl font-black text-sm border border-[#24344D] flex items-center gap-3">
            ...
            {/* Hero Header */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-900 to-slate-900 border border-[#24344D] p-8 shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="text-center md:text-left flex-1">
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-3">
                            <span className="px-3 py-1 rounded-full bg-brand-500/10 text-brand-400 text-[10px] font-black uppercase tracking-widest border border-brand-500/20">
                                {tournament.type === 'knockout' ? 'ðŸ† Knockout' :
                                    tournament.type === 'pool' ? 'ðŸŠ Pool + Knockout' :
                                        tournament.type === 'dual_knockout' ? 'ðŸŒ± 2-Pool Knockout' : 'ðŸ“‹ League'}
                            </span>
                            <span className={cn(
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-[#94A3B8]">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-[#131D31]/50 backdrop-blur-sm rounded-2xl p-4 border border-[#24344D]/40 text-center">
                            <div className="text-2xl font-black text-white">{tournament.teamsCount || 0}</div>
                            <div className="text-[10px] text-[#64748B] uppercase font-bold">Teams</div>
                        </div>
                        <div className="bg-[#131D31]/50 backdrop-blur-sm rounded-2xl p-4 border border-[#24344D]/40 text-center">
                            <div className="text-2xl font-black text-white">{tournamentMatches.length || tournament.matchesCount || 0}</div>
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            activeTab === tab.id
                                ...
                                : "bg-[#131D31]/50 text-[#94A3B8] hover:bg-[#131D31]/10"
                        )}
                    >
                        <tab.icon size={18} />
                        {tab.label}
            ...
            <div className="min-h-[400px]">
                {activeTab === 'fixtures' && (
                    <div className="space-y-8">
                        ...
                        {Object.keys(matchesByRound).length > 0 ? (
                                        ...
                                        {matches.map(match => {
                                            ...
                                            return (
                                                <Link
                                                    key={match.id}
                                                    to={`/live/${match.id}`}
                                                    className="group relative bg-[#0B1220] border border-[#24344D]/40 rounded-2xl p-5 hover:border-brand-500/30 transition-all shadow-lg"
                                                >
                                                    {canEditTournament && (
                                                    ...
                                                    <div className="flex items-center justify-between gap-4">
                                                        <div className="flex-1 flex flex-col items-center">
                                                            <div className="w-12 h-12 bg-[#131D31]/50 rounded-full flex items-center justify-center mb-2 overflow-hidden border border-[#24344D]/40 group-hover:border-brand-500/30 transition-colors p-2">
                                                                {teamA?.logoUrl ? (
                                                            ...
                                                            <div className="text-[10px] text-[#64748B] font-black uppercase tracking-widest whitespace-nowrap flex flex-col items-center">
                                                                ...
                                                                {match.status === 'live' && (
                                                                    <span className="flex items-center gap-1 text-red-500">
                                                                        ...
                                                                        LIVE â€¢ {match.scoreA} - {match.scoreB}
                                                                    </span>
                                                                )}
                            ...
                            <div className="text-center py-20 bg-[#131D31]/50 rounded-3xl border border-dashed border-[#24344D]">
                        ...
                        {showScheduleMatch && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0B1220]/90 backdrop-blur-sm">
                                <div className="bg-[#0B1220] border border-[#24344D] rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden">
                                    <div className="p-6 border-b border-[#24344D]/40 flex justify-between items-center bg-brand-500/5">
                                        <h3 className="text-xl font-black text-white italic">Schedule New Match</h3>
                                        <button onClick={() => setShowScheduleMatch(false)} className="text-[#94A3B8] hover:text-white transition-colors">
                                            <X size={24} />
                                        </button>
                                    </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-[#0B1220] bg-[#131D31] border border-[#24344D]/40 rounded-xl p-3 text-white outline-none focus:border-brand-500 transition-all"
                                                    required
                                                >
                ...
                {activeTab === 'standings' && (
                    <div className="bg-[#0B1220] rounded-3xl border border-[#24344D] overflow-hidden">
                        <table className="w-full text-left">
                            <thead className="bg-[#131D31]/50 border-b border-[#24344D] text-[10px] uppercase font-black text-[#64748B] tracking-widest">
                                <tr>
                            ...
                            <tbody className="divide-y divide-white/5">
                                {standings.map((team, idx) => (
                                    <tr key={team.id} className="hover:bg-[#131D31]/5 transition-colors">
                                        <td className="px-6 py-4 font-black text-[#64748B]">{idx + 1}</td>
                                        <td className="px-6 py-4">
                                            <Link to={`/teams/${team.id}`} className="flex items-center gap-3 text-white font-bold hover:text-brand-400 transition-colors">
                                                {team.logoUrl ? (
                                        ...
                                        <td className="px-4 py-4 text-center font-bold text-[#94A3B8]">{team.played}</td>
                                        <td className="px-4 py-4 text-center font-bold text-[#94A3B8]">{team.wins}</td>
                                        <td className="px-4 py-4 text-center font-bold text-[#94A3B8]">{team.draws}</td>
                                        <td className="px-4 py-4 text-center font-bold text-[#94A3B8]">{team.losses}</td>
                ...
                {activeTab === 'pools' && tournament.type === 'pool' && (
                    <div className="space-y-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            {/* Pool A */}
                            <div className="bg-[#0B1220] rounded-3xl border border-[#24344D] overflow-hidden">
                                <div className="px-6 py-4 bg-indigo-500/10 border-b border-[#24344D]/40">
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        {poolAStandings.map((team, idx) => (
                                            <tr key={team.name} className={cn(
                                                "hover:bg-[#131D31]/5 transition-colors",
                                                ...
                                                <td className="px-3 py-3 text-center text-[#94A3B8]">{team.played}</td>
                                                <td className="px-3 py-3 text-center text-[#94A3B8]">{team.wins}</td>
                                                <td className="px-3 py-3 text-center text-[#94A3B8]">{team.draws}</td>
                                                <td className="px-3 py-3 text-center text-[#94A3B8]">{team.losses}</td>
                            ...
                            {/* Pool B */}
                            <div className="bg-[#0B1220] rounded-3xl border border-[#24344D] overflow-hidden">
                                <div className="px-6 py-4 bg-orange-500/10 border-b border-[#24344D]/40">
                                    <h3 className="text-lg font-display font-black text-white flex items-center gap-2">
                        ...
                        {/* Qualification Info */}
                        <div className="flex items-center justify-center gap-6 py-3 bg-[#131D31]/50 rounded-2xl border border-[#24344D]/40">
                            <div className="flex items-center gap-2">
                                <div className="w-3 h-1 bg-green-500 rounded" />
                                <span className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider">Qualifies to Semi-Finals</span>
                            </div>
                            <span className="text-[#94A3B8]">â€¢</span>
                            <span className="text-[10px] text-[#64748B]">Semi-Finals: A1 vs B2, B1 vs A2 â†’ Final</span>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'bracket' && (
                    <div className="space-y-6">
                        {canEditTournament && (
                            <div className="flex justify-end gap-3 mb-4">
                                ...
                                {tournamentMatches.length === 0 && (
                                    <button
                                        onClick={handleSeedBracket}
                                        className="px-4 py-2 bg-brand-500 text-white rounded-xl font-black text-xs hover:scale-105 transition-all shadow-lg shadow-brand-500/20"
                                    >
                        ...
                        {/* Full-width bracket â€” perfectly centered breaking out of max-w-7xl without scrollbars */}
                        <div 
                            className="relative" 
                            style={{ 
                                width: '100vw', 
                ...
                {activeTab === 'teams' && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {tournamentTeams.map(team => (
                                <Link
                                    key={team.id}
                                    to={`/teams/${team.id}`}
                                    className="relative group bg-[#0B1220] border border-[#24344D]/40 p-6 rounded-3xl hover:border-brand-500/20 transition-all text-center flex flex-col items-center shadow-lg"
                                >
                                    {canEditTournament && (
                                        <button
                                            onClick={(e) => {
                                            ...
                                            className="absolute top-2 right-2 p-2 bg-red-500/10 text-red-500 rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-500 hover:text-white transition-all z-20"
                                        >
                                            <X size={14} />
                                        </button>
                                    )}
                                    ...
                                    <h4 className="text-lg font-bold text-white mb-1 group-hover:text-brand-400 transition-colors">{team.name}</h4>
                        ...
                        {showAddTeam && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0B1220]/90 backdrop-blur-sm">
                                <div className="bg-[#0B1220] border border-[#24344D] rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
                                    <div className="p-6 border-b border-[#24344D]/40 flex justify-between items-center bg-brand-500/5">
                                        <h3 className="text-xl font-black text-white italic">Add Team to {tournament.name}</h3>
                                        <button onClick={() => setShowAddTeam(false)} className="text-[#94A3B8] hover:text-white transition-colors">
                                            <X size={24} />
                                        </button>
                                    </div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[#0B1220] bg-[#131D31] border border-[#24344D]/40 rounded-2xl py-3 pl-10 pr-4 text-white placeholder:text-slate-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all"
                                            />
                                        </div>
                                            ...
                                            {availableTeams.length > 0 ? (
                                                <div className="grid grid-cols-1 gap-2">
                                                    {availableTeams.map(team => (
                                                        ...
                                                        >
                                                            <div className="w-10 h-10 bg-[#0B1220] bg-[#131D31] rounded-xl flex items-center justify-center border border-[#24344D]/40">
                                                                {team.logoUrl ? (
