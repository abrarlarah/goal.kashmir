...
const ManageSponsors = () => {
    ...
    if (!isAdmin) return <div className="text-white text-white text-center py-20">Access Denied</div>;
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            <h1 className="text-3xl font-display font-bold text-white text-white mb-6">Manage Sponsors</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="glass-card p-6 rounded-2xl sticky top-24">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Company/Sponsor Name*</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Website URL (Optional)</label>
                                <input
                                    type="text"
                                    className="w-full bg-black/20 border border-slate-200/10 border-[#24344D] rounded-lg px-4 py-2 text-white text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Tier</label>
                                    <select
                                        className="w-full bg-black/20 border border-slate-200/10 border-[#24344D] rounded-lg px-4 py-2 text-white text-white focus:ring-1 focus:ring-brand-500 outline-none"
                                        value={formData.tier}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Target</label>
                                    <select
                                        className="w-full bg-black/20 border border-slate-200/10 border-[#24344D] rounded-lg px-4 py-2 text-white text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Logo Image*</label>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-2 w-full">
                                        <button
                                            ...
                                            disabled={uploading}
                                            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#131D31]/50 hover:bg-white/10 border border-slate-200/10 border-[#24344D] rounded-lg text-sm text-[#94A3B8] text-[#94A3B8] transition-colors w-full"
                                        >
                                            <Upload size={16} />
                                    ...
                                    {/* Preview */}
                                    {formData.logoUrl && (
                                        <div className="relative mt-2 p-4 rounded-lg bg-[#1E2B42] border border-slate-200/10 border-[#24344D] flex items-center justify-center group h-32">
                            ...
                            <div className="flex items-center gap-2 mt-4 pt-2 border-t border-slate-200/10 border-[#24344D]">
                                <input
                                    type="checkbox"
                                    id="activeStatus"
                                    checked={formData.active}
                                    onChange={e => setFormData({ ...formData, active: e.target.checked })}
                                    className="w-4 h-4 text-brand-400 bg-black/20 border-slate-200/10 border-[#24344D] rounded rounded-lg focus:ring-brand-500 focus:ring-2"
                                />
                                <label htmlFor="activeStatus" className="text-sm font-medium text-[#94A3B8] text-[#94A3B8]">
                            ...
                            <button
                                type="submit"
                                disabled={uploading}
                                className="w-full bg-brand-600 hover:bg-brand-500 text-white text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-brand-500/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
                            >
                                {uploading ? (
                                    <>
                ...
                <div className="lg:col-span-2 space-y-4">
                    <h2 className="text-xl font-bold text-white text-white mb-4">Current Sponsors</h2>
                    {loading ? (
                        ...
                        <div className="space-y-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <h3 className="font-bold text-white text-white text-lg leading-tight truncate flex items-center gap-2">
                                                    {item.name}
                            ...
                            {sponsors.length === 0 && (
                                <div className="text-center py-10 bg-[#131D31]/50 rounded-xl border border-dashed border-slate-200/10 border-[#24344D] text-[#64748B]">
