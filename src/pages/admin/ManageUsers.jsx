...
const ROLE_CONFIG = {
    ...
    teamadmin: { label: 'Team Admin', color: 'text-green-400 bg-emerald-400/10 border-emerald-400/20', icon: Shield },
        ...
        <div className="container mx-auto px-4 py-8 text-white text-white">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-[#64748B] dark:text-gray-400 text-sm mt-1">Assign roles to control who can manage tournaments and data.</p>
                </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                <div className="flex items-center gap-4 flex-1">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-[#64748B] dark:text-gray-400">{user.email}</div>
