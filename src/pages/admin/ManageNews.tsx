...
const ManageNews = () => {
    ...
    if (!isNewsAdmin && !isSuperAdmin) return <div className="text-white text-center py-20">Access Denied</div>;
                ...
                <div className="lg:col-span-1">
                    <div className="glass-card p-6 rounded-2xl sticky top-24">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Article Image</label>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                ...
                                <div className="space-y-3">
                                    ...
                                    {!showCamera && (
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                disabled={uploading}
                                                className="flex items-center justify-center gap-2 px-4 py-2 bg-[#131D31]/50 hover:bg-[#131D31]/10 border border-[#24344D] rounded-lg text-sm text-[#94A3B8] transition-colors"
                                            >
                                                <Upload size={16} />
                                                <span>Upload</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                onClick={startCamera}
                                                disabled={uploading}
                                                className="flex items-center justify-center gap-2 px-4 py-2 bg-[#0B1220]/60 dark:bg-[#131D31]/50 hover:bg-[#18253C] dark:bg-[#131D31] text-[#94A3B8] rounded-lg text-sm transition-colors col-span-2"
                                            >
                                                <Camera size={16} />
                                    ...
                                    {formData.imageUrl && !showCamera && (
                                        <div className="relative mt-2 rounded-lg overflow-hidden aspect-video border border-[#24344D] bg-black/40 group">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Summary (Excerpt)</label>
                                <textarea
                                    required
                                    rows="2"
                                    className="w-full bg-black/20 border border-[#24344D] rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Full Content</label>
                                <textarea
                                    required
                                    rows="6"
                                    className="w-full bg-black/20 border border-[#24344D] rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            {news.map(item => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[#94A3B8] text-sm mt-2 line-clamp-2">{item.excerpt}</p>
