...
const ManageNews = () => {
    ...
    if (!isNewsAdmin && !isSuperAdmin) return <div className="text-white text-white text-center py-20">Access Denied</div>;

    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            <h1 className="text-3xl font-display font-bold text-white text-white mb-6">Manage News</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="glass-card p-6 rounded-2xl sticky top-24">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Title</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Article Image</label>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                            ...
                                            >
                                                ...
                                                <div className="absolute bottom-4 inset-x-0 flex justify-center gap-4">
                                                    <button
                                                        ...
                                                        className="h-12 w-12 rounded-full bg-[#131D31] border-4 border-[#24344D] flex items-center justify-center hover:bg-slate-200 transition-colors shadow-lg"
                                                    >
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={stopCamera}
                                                        className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-black/50 rounded-full text-white text-white hover:bg-red-500 transition-colors"
                                                    >
                                                        <X size={20} />
                                                    </button>
                                                </div>
                                    ...
                                    {!showCamera && (
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                disabled={uploading}
                                                className="flex items-center justify-center gap-2 px-4 py-2 bg-[#131D31]/50 hover:bg-white/10 border border-slate-200/10 border-[#24344D] rounded-lg text-sm text-[#94A3B8] text-[#94A3B8] transition-colors"
                                            >
                                                <Upload size={16} />
                                                <span>Upload</span>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                onClick={startCamera}
                                                disabled={uploading}
                                                className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-100/50 dark:bg-slate-700/50 hover:bg-[#18253C] dark:bg-slate-700 text-[#94A3B8] text-[#94A3B8] rounded-lg text-sm transition-colors col-span-2"
                                            >
                                                <Camera size={16} />
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Summary (Excerpt)</label>
                                <textarea
                                    required
                                    rows="2"
                                    className="w-full bg-black/20 border border-slate-200/10 border-[#24344D] rounded-lg px-4 py-2 text-white text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] text-[#94A3B8] mb-1">Full Content</label>
                                <textarea
                                    required
                                    rows="6"
                                    className="w-full bg-black/20 border border-slate-200/10 border-[#24344D] rounded-lg px-4 py-2 text-white text-white focus:ring-1 focus:ring-brand-500 outline-none"
                            ...
                            <button
                                type="submit"
                                disabled={uploading}
                                className="w-full bg-brand-600 hover:bg-brand-500 text-white text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-brand-500/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {uploading ? (
                                    <>
                ...
                <div className="lg:col-span-2 space-y-4">
                    <h2 className="text-xl font-bold text-white text-white mb-4">Published Articles</h2>
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            {news.map(item => (
                                ...
                                >
                                    <div className="w-24 h-24 bg-[#0B1220] bg-[#131D31] rounded-lg overflow-hidden flex-shrink-0 relative">
                                        {item.imageUrl ? (
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <h3 className="font-bold text-white text-white text-lg leading-tight truncate">{item.title}</h3>
                                            </div>
                                        ...
                                        <p className="text-[#94A3B8] text-[#94A3B8] text-sm mt-2 line-clamp-2">{item.excerpt}</p>
