...
const Admin = () => {
  ...
  if (isTeamManager) {
    adminCards.push(
      ...
      { to: '/admin/lineups', icon: Shield, title: 'âš½ Manage Lineups', desc: 'Set starting 11 and bench players for matches', color: 'from-teal-500/20 to-teal-600/5 border-teal-500/20' }
    );
  }
  ...
  if (isContentCreator) {
    adminCards.push({ to: '/admin/news', icon: Newspaper, title: 'ðŸ“° Manage News', desc: 'Publish articles and announcements', color: 'from-pink-500/20 to-pink-600/5 border-pink-500/20' });
  }
        ...
        {isSuperAdmin && (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-semibold text-white">ðŸ‘‘ Manage Users</h2>
            </div>
        ...
        {isSuperAdmin && (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-semibold text-white">ðŸ“‹ Audit Logs</h2>
            </div>
