...
const ManageGallery = () => {
    ...
    if (!hasAnyAdminAccess) return <div className="text-white text-center py-20">Access Denied</div>;

    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            <h1 className="text-3xl font-display font-bold text-white mb-6">Manage Gallery</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="glass-card p-6 rounded-2xl sticky top-24">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Image</label>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            disabled={uploading}
                                            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#131D31]/50 hover:bg-[#131D31]/10 border border-[#24344D] rounded-lg text-sm transition-colors"
                                        >
                                            <Upload size={16} />
                                            <span>Upload</span>
                                        </button>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Title / Caption</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#94A3B8] mb-1">Date (Optional)</label>
                                <input
                                    type="text"
                            ...
                            <button
                                type="submit"
                                disabled={uploading}
                                className="w-full bg-brand-600 hover:bg-brand-500 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-brand-500/20 flex items-center justify-center gap-2"
                            >
                                {uploading ? (
                                    <>
                ...
                <div className="lg:col-span-2 space-y-4">
                    <h2 className="text-xl font-bold text-white mb-4">Gallery Photos</h2>
                    {loading ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            {photos.length === 0 && (
                                <div className="col-span-full text-center py-10 bg-[#131D31]/50 rounded-xl border border-dashed border-[#24344D] text-[#64748B]">
