        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-[#94A3B8] font-display font-medium animate-pulse">Scouting Player Details...</div>
                </div>
            </div>
        );
    }
    ...
    if (!player) {
        return (
            <div className="max-w-7xl mx-auto px-4 py-20 text-center">
                <UserIcon size={64} className="mx-auto text-[#94A3B8] dark:text-slate-700 mb-6" strokeWidth={1.5} />
                <h2 className="text-3xl font-display font-bold text-white mb-4">Player Not Found</h2>
                <p className="text-[#94A3B8] mb-8 max-w-md mx-auto">We couldn't find the player you're looking for. They might have been transferred or retired.</p>
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div className="flex justify-between items-center mb-8">
                <Link
                    to="/players"
                    className="inline-flex items-center gap-2 text-[#94A3B8] hover:text-brand-500 transition-colors group"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <motion.div
                    ...
                    className="lg:col-span-1 glass-card rounded-3xl overflow-hidden border border-[#24344D] shadow-2xl"
                >
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/40">
                            ...
                            <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/40">
                                ...
                                <span className="text-xl font-display font-bold text-white">{age}</span>
                            </div>
                            {player.nationality && (
                                <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/40 md:col-span-2">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 text-[#94A3B8]">
                                ...
                                <div>
                                    ...
                                    {team ? (
                                        <Link to={`/teams/${team.id}`} className="font-bold text-white hover:text-brand-500 transition-colors block mt-0.5">
                                            {player.team}
                                        </Link>
                                    ) : (
                                        <span className="font-bold text-white mt-0.5 block">{player.team}</span>
                                    )}
                                </div>
                            </div>
                            <div className="flex items-center gap-3 text-[#94A3B8]">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    >
                        {[
                            ...
                            <div key={idx} className="glass-card p-6 rounded-3xl border border-[#24344D]/40 text-center group hover:border-[#24344D]/20 border-[#24344D] transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <motion.div
                            ...
                            className="glass-card p-6 rounded-3xl border border-[#24344D]/40"
                        >
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-[#94A3B8]">Yellow Cards</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-[#94A3B8]">Red Cards</span>
                                    </div>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {recentEvents.map((event, idx) => (
                                    <div key={idx} className="flex items-center gap-3 p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/40 hover:bg-[#131D31]/10 transition-colors">
                                        <div className={cn(
                                        ...
                                        <div className="text-xs">
                                            ...
                                            <div className="text-[#64748B]">v {event.opponent} â€¢ {event.date}</div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            {tournamentStats.length > 0 ? tournamentStats.map(t => (
                                <div key={t.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/40 hover:border-brand-500/30 transition-colors">
                                    <div>
                                    ...
                                    <div className="flex gap-6">
                                        <div className="text-center">
                                            <div className="text-lg font-bold text-white leading-none">{t.matches}</div>
                                            <div className="text-[10px] text-[#64748B] uppercase tracking-wider font-bold mt-1">Matches</div>
                                        </div>
                                        <div className="text-center">
                                            <div className="text-lg font-bold text-white leading-none">{t.goals}</div>
                    ...
                    <motion.div
                        ...
                        className="glass-card p-8 rounded-3xl border border-[#24344D]/40 bg-gradient-to-br from-brand-500/5 to-transparent"
                    >
                        <h3 className="text-xl font-display font-bold mb-4 text-white">About {player.name.split(' ')[0]}</h3>
