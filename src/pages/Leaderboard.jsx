  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-2 w-full md:w-auto overflow-x-auto scrollbar-none pb-1 md:pb-0">
          <select
            value={selectedYear}
            onChange={(e) => {
      ...
      <div className="flex gap-2 p-1 bg-white/5 backdrop-blur-md rounded-2xl w-full md:w-fit border border-slate-200/5 dark:border-white/5 overflow-x-auto scrollbar-none">
        {[
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-4 md:px-6 py-2 rounded-xl text-[10px] md:text-sm font-bold transition-all whitespace-nowrap flex-shrink-0",
              activeTab === tab.id
