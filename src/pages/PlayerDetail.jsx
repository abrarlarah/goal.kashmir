        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-[#94A3B8] text-[#94A3B8] font-display font-medium animate-pulse">Scouting Player Details...</div>
                </div>
            </div>
        );
    }
    ...
    if (!player) {
        return (
            <div className="max-w-7xl mx-auto px-4 py-20 text-center">
                <UserIcon size={64} className="mx-auto text-[#94A3B8] text-[#94A3B8] dark:text-slate-700 mb-6" strokeWidth={1.5} />
                <h2 className="text-3xl font-display font-bold text-white text-white mb-4">Player Not Found</h2>
                <p className="text-[#94A3B8] text-[#94A3B8] mb-8 max-w-md mx-auto">We couldn't find the player you're looking for. They might have been transferred or retired.</p>
                <Link to="/players" className="inline-flex items-center gap-2 px-6 py-3 bg-brand-600 hover:bg-brand-500 text-white text-white rounded-xl font-bold transition-all shadow-lg shadow-brand-500/20">
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div className="flex justify-between items-center mb-8">
                <Link
                    to="/players"
                    className="inline-flex items-center gap-2 text-[#94A3B8] text-[#94A3B8] hover:text-brand-500 transition-colors group"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <motion.div
                    ...
                    className="lg:col-span-1 glass-card rounded-3xl overflow-hidden border border-slate-200/10 border-[#24344D] shadow-2xl"
                >
                    <div className="relative aspect-square bg-[#0B1220] bg-[#131D31]">
                        {player.photoUrl ? (
                        ...
                        <div className="absolute bottom-6 left-6 flex flex-col items-start">
                            <span className="px-3 py-1 bg-brand-600 text-white text-white text-[10px] font-black uppercase tracking-widest rounded-lg mb-2 shadow-lg">
                                {player.position}
                            </span>
                            <h1 className="text-3xl font-display font-bold text-white text-white drop-shadow-md">
                                {player.name}
                            </h1>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/30 border-[#24344D]/50">
                                <span className="text-[10px] text-[#64748B] uppercase font-black tracking-wider block mb-1">Squad Number</span>
                                <span className="text-xl font-display font-bold text-white text-white">#{player.number || '--'}</span>
                            </div>
                            <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/30 border-[#24344D]/50">
                                <span className="text-[10px] text-[#64748B] uppercase font-black tracking-wider block mb-1">Age</span>
                                <span className="text-xl font-display font-bold text-white text-white">{age}</span>
                            </div>
                            {player.nationality && (
                                <div className="p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/30 border-[#24344D]/50 md:col-span-2">
                                    <span className="text-[10px] text-[#64748B] uppercase font-black tracking-wider block mb-1">Nationality</span>
                                    <span className="text-sm font-bold text-white text-white">{player.nationality}</span>
                                </div>
                            )}
                        </div>

                        <div className="space-y-4">
                            <div className="flex items-center gap-3 text-[#94A3B8] text-[#94A3B8]">
                                <Shield className="text-brand-500" size={20} />
                                <div>
                                    <span className="text-xs text-[#64748B] block">Current Team</span>
                                    {team ? (
                                        <Link to={`/teams/${team.id}`} className="font-bold text-white text-white hover:text-brand-500 transition-colors block mt-0.5">
                                            {player.team}
                                        </Link>
                                    ) : (
                                        <span className="font-bold text-white text-white mt-0.5 block">{player.team}</span>
                                    )}
                                </div>
                            </div>
                            <div className="flex items-center gap-3 text-[#94A3B8] text-[#94A3B8]">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    >
                        {[
                            ...
                            <div key={idx} className="glass-card p-6 rounded-3xl border border-[#24344D]/30 border-[#24344D]/50 text-center group hover:border-slate-200/20 dark:border-white/20 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <motion.div
                            ...
                            className="glass-card p-6 rounded-3xl border border-[#24344D]/30 border-[#24344D]/50"
                        >
                            <h3 className="text-lg font-bold mb-6 flex items-center gap-2 text-white text-white">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-[#94A3B8] text-[#94A3B8]">Yellow Cards</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-semibold text-[#94A3B8] text-[#94A3B8]">Red Cards</span>
                                    </div>
                        ...
                        <motion.div
                            ...
                            className="glass-card p-6 rounded-3xl border border-[#24344D]/30 border-[#24344D]/50"
                        >
                            <h3 className="text-lg font-bold mb-4 flex items-center gap-2 text-white text-white">
                                <History size={20} className="text-brand-500" />
                                Recent Activity
                            </h3>
                            <div className="space-y-4">
                                {recentEvents.map((event, idx) => (
                                    <div key={idx} className="flex items-center gap-3 p-3 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/30 border-[#24344D]/50 hover:bg-white/10 transition-colors">
                                        <div className={cn(
                                        ...
                                        <div className="text-xs">
                                            ...
                                            <div className="text-[#64748B]">v {event.opponent} • {event.date}</div>
                                        </div>
                                    </div>
                                ))}
                                {recentEvents.length === 0 && (
                                    <div className="text-center py-8 text-[#64748B] italic text-xs">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            <h3 className="text-lg font-bold flex items-center gap-2 text-white text-white">
                                <Trophy size={20} className="text-brand-500" />
                        ...
                        <div className="space-y-4">
                            {tournamentStats.length > 0 ? tournamentStats.map(t => (
                                <div key={t.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-[#131D31]/50 border border-[#24344D]/30 border-[#24344D]/50 hover:border-brand-500/30 transition-colors">
                                    <div>
                                        <div className="font-bold text-white text-white text-sm">{t.name}</div>
                                        <div className="text-xs text-[#64748B] mt-1">{t.registered ? 'Registered / Active' : 'Played Matches Here'}</div>
                                    </div>
                                    <div className="flex gap-6">
                                        <div className="text-center">
                                            <div className="text-lg font-bold text-white text-white leading-none">{t.matches}</div>
                                            <div className="text-[10px] text-[#64748B] uppercase tracking-wider font-bold mt-1">Matches</div>
                                        </div>
                                        <div className="text-center">
                                            <div className="text-lg font-bold text-white text-white leading-none">{t.goals}</div>
                                            <div className="text-[10px] text-[#64748B] uppercase tracking-wider font-bold mt-1">Goals</div>
                                        </div>
                                    </div>
                                </div>
                            )) : (
                    ...
                    <motion.div
                        ...
                        className="glass-card p-8 rounded-3xl border border-[#24344D]/30 border-[#24344D]/50 bg-gradient-to-br from-brand-500/5 to-transparent"
                    >
                        <h3 className="text-xl font-display font-bold mb-4 text-white text-white">About {player.name.split(' ')[0]}</h3>
                        <p className="text-[#94A3B8] text-[#94A3B8] leading-relaxed">
