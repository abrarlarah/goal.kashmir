                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      {editMode && canEditPlayer(player) ? (
                        ...
                        <span className={cn("text-sm font-bold", display.goals > 0 ? "text-brand-400" : "text-[#94A3B8]")}>
                          {display.goals || 0}
                        </span>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      {editMode && canEditPlayer(player) ? (
                        ...
                        <span className={cn("text-sm font-medium", display.assists > 0 ? "text-blue-400" : "text-[#94A3B8]")}>
                          {display.assists || 0}
                        </span>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex justify-center gap-1">
                        ...
                        {(!display.yellowCards && !display.redCards) && <span className="text-[#94A3B8]">-</span>}
                      </div>
                    </td>
                    {isAdmin && (
