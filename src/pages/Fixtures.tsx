        ...
        <div className="relative z-10 p-6 sm:p-8 lg:p-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
            ...
            <div className="flex gap-3">
              <div className="px-4 py-2 rounded-xl bg-[#131D31]/50 border border-white/10 backdrop-blur-md text-center">
                ...
                <div className="text-[10px] font-bold text-[#64748B] uppercase tracking-wider">Total</div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative">
              ...
              <ChevronRight size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#64748B] rotate-90 pointer-events-none" />
            </div>
          ...
          {(filterStatus !== 'All' || filterTournament !== 'All' || searchQuery) && (
            <div className="flex flex-wrap items-center gap-2 mt-4">
              ...
              <button onClick={() => { setFilterStatus('All'); setFilterTournament('All'); setSearchQuery(''); }} className="text-[10px] font-bold text-[#64748B] hover:text-white transition-colors ml-1 underline underline-offset-2">
                Clear all
              </button>
            </div>
          )}
                          ...
                          <div className="flex justify-between items-center mb-4">
                            <div className="flex items-center gap-2.5">
                              <span className={cn(
                                ...
                                Match {globalMatchNumbers[match.id] || 'â€”'}
                              </span>
                              <span className="text-[10px] sm:text-xs font-bold text-[#64748B] dark:text-slate-500 uppercase tracking-wider truncate max-w-[140px] sm:max-w-[200px]">
                                {match.competition}
                              </span>
                            </div>
                            ...
                            <div>
                              ...
                              {isFinished && (
                                <span className="inline-flex items-center gap-1 bg-green-500/10 border border-green-500/20 text-green-400 text-green-400 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider">
                                  Full Time
                                </span>
                              )}
