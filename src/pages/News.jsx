...
const News = () => {
        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-[#94A3B8] font-medium animate-pulse">Loading News...</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8 sm:space-y-12">
            ...
            >
                <h1 className="text-2xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-3 sm:mb-4">Latest News</h1>
                <p className="text-[#94A3B8] text-sm sm:text-base md:text-lg">Stay updated with the latest match reports, transfer news, and club announcements.</p>
            </motion.div>
            ...
            {news.length > 0 ? (
                    ...
                    >
                        <motion.div variants={item} className="h-full w-full">
                            ...
                            <div className="absolute bottom-0 left-0 p-4 sm:p-8 space-y-2 sm:space-y-3">
                                ...
                                <h2 className="text-xl sm:text-2xl md:text-4xl font-display font-bold text-white leading-tight max-w-2xl group-hover:text-brand-400 transition-colors line-clamp-3">
                                    {news[0].title}
                                </h2>
                                <p className="text-[#94A3B8] line-clamp-2 max-w-xl text-sm md:text-base">
                                    {news[0].excerpt}
                                </p>
                                <div className="flex items-center gap-2 text-[#94A3B8] text-xs font-medium pt-2">
                                    <Calendar size={14} />
                            ...
                            <motion.div variants={item} className="h-full flex flex-col">
                                <div className="relative aspect-video overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <span className="px-2 py-1 bg-black/60 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-wider rounded border border-[#24344D]">
                                            {article.category}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-3 sm:p-5 flex flex-col flex-1">
                                    <h3 className="text-base sm:text-xl font-display font-bold text-white mb-2 line-clamp-2 group-hover:text-brand-400 transition-colors">
                                        {article.title}
                                    </h3>
                                    <p className="text-[#94A3B8] text-sm line-clamp-3 mb-4 flex-1">
                                        {article.excerpt}
                                    </p>

                                    <div className="flex items-center justify-between pt-4 border-t border-[#24344D]/40 mt-auto">
                ...
                <div className="text-center py-20 bg-[#131D31]/50 rounded-3xl border border-dashed border-[#24344D]">
                    ...
                    <p className="text-[#94A3B8]">Check back later for the latest updates from the league.</p>
                </div>
            )}
        </div>
    );
